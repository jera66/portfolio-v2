      ...
      <div className="container experience-wrapper">
        ...
        <div className="timeline-block timeline-block-right">
          ...
          <div className="timeline-content">
            <h3>OCT-NOV 2020</h3>
            <p>
              Finished my second bootcamp (100 hours) course at udemy with
        ...
        <div className="timeline-block timeline-block-left">
          ...
          <div className="timeline-content">
            <h3>AUG-OCT 2020</h3>
            <p>
              Finished my first fulltime coding bootcamp (600+ hours) at General
              Assembly, NY
            </p>
          </div>
        </div>
        <div className="timeline-block timeline-block-right">
          ...
          <div className="timeline-content">
            <h3>2011 - 2014</h3>
            <p>
              Nassau College -Garden City, NY, 56 credits towards associate in
